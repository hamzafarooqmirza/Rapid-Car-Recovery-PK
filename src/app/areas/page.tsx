...
const areas = [
  {
    name: "Al Nahda",
    nameAr: "النهدة",
    desc: "Quick response to breakdowns and towing requests around Al Nahda's busy streets.",
    icon: "fa-solid fa-city",
  },
  {
    name: "Al Majaz",
    nameAr: "المجاز",
    desc: "Recovery and roadside support around Al Majaz and the corniche area.",
  ...
  },
  {
    ...
    desc: "Support for commercial vehicles and fleet breakdowns across Sharjah's industrial zones.",
    icon: "fa-solid fa-warehouse",
  },
  {
    name: "University City",
    nameAr: "المدينة الجامعية",
    desc: "Roadside assistance and towing for students and staff around University City.",
  ...
  {
    name: "Sharjah Airport Road",
    nameAr: "طريق مطار الشارقة",
    desc: "24/7 coverage for breakdowns and accidents along Sharjah Airport Road and nearby routes.",
